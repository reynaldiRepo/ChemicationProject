                    ...
                    <div class="widget-tabs-list">
                        ...
                        <div class="tab-content tab-custom-st">
                            ...
                            <div id="anggota2" class="tab-pane fade in active">
                                <form action="<?php echo base_url('Home/Update_anggota2CEO') ?>" id="form">
                                    <div class="tab-ctn">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <div class="bootstrap-select fm-cmp-mg">
                                                                            <select class="selectpicker"
                                                                                name="jk_anggota2_ceo" id="jk_anggota2_ceo" disabled = "disabled">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            ...
                                                                            id="alamat_anggota2_ceo" disabled = "disabled" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            ...
                                                                            id="kontak_anggota2_ceo" disabled = "disabled" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <img src="<?php echo base_url('uploaded/CEO/PasFoto/'.$foto)?>"
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                    <img src="<?php echo base_url('uploaded/CEO/Scan/'.$scan)?>"
                                                                        class="img-fluid" style="max-width : 200px;">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <button class="btn btn-success notika-btn-success"
                                                                    type="submit">Klik untuk rubah data</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
