                    ...
                    <div class="widget-tabs-list">
                        ...
                        <div class="tab-content tab-custom-st">
                            ...
                            <div id="anggota1" class="tab-pane fade in active">
                                <form action="<?php echo base_url('Home/Update_anggota1CEO') ?>" id="form">
                                    <div class="tab-ctn">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <div class="bootstrap-select fm-cmp-mg">
                                                                            <select class="selectpicker"
                                                                                name="jk_anggota1_ceo" id="jk_anggota1_ceo" disabled = "disabled">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            ...
                                                                            id="alamat_anggota1_ceo" disabled = "disabled" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            ...
                                                                            id="kontak_anggota1_ceo" disabled = "disabled" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
