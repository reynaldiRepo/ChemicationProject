...
?>
 ...
 <div class="container">
                ...
                <div class="widget-tabs-int">
                    ...
                    <div class="widget-tabs-list">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="<?php echo base_url('Home/KetuaCEO') ?>">Ketua</a></li>
                        ...
                        <div class="tab-content tab-custom-st">
                            ...
                            <div id="ketua" class="tab-pane fade in active">
                                <?php echo form_open_multipart('Home/submit_data_ketuaCEO')?>
                                    <div class="tab-ctn">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-example">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder="NISN" name="nisn_ketua_ceo"
                                                                            id="nisn_ketua_ceo"
                                                    ...
                                                    <div class="form-example-int form-horizental mg-t-15">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                                                    <label class="hrzn-fm">Nama Ketua</label>
                                                                </div>
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Nama" name="nama_ketua_ceo"
                                                                            id="nama_ketua_ceo"
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <div class="bootstrap-select fm-cmp-mg">
                                                                            <select class="selectpicker"
                                                                                name="jk_ketua_ceo" id="jk_ketua_ceo">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Kota" name="kota_ketua_ceo"
                                                                            id="kota_ketua_ceo" 
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control"
                                                                            name="tgl_ketua_ceo" id="tgl_ketua_ceo"
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="number"
                                                                            ...
                                                                            name="kelas_ketua_ceo" id="kelas_ketua_ceo"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Alamat" name="alamat_ketua_ceo"
                                                                            value="<?php if (isset($alamat)) {echo $alamat;}?>"
                                                                            id="alamat_ketua_ceo" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Kontak" name="kontak_ketua_ceo"
                                                                            value="<?php if (isset($kontak)) {echo $kontak;}?>"
                                                                            id="kontak_ketua_ceo" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="file" class="form-control input-sm"
                                                                            ...
                                                                            name="foto_ketua_ceo" id="foto_ketua_ceo"
                                                                            accept="image/*"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="file" class="form-control input-sm"
                                                                            placeholder="Scan" name="scan_ketua_ceo"
                                                                            id="scan_ketua_ceo" accept="image/*"
    ...
    <script>
        var uploadField1 = document.getElementById("foto_ketua_ceo");
        ...
        var uploadField2 = document.getElementById("scan_ketua_ceo");
