...
if (isset($data_anggota2)) {
    foreach($data_anggota2 as $data){
        $nisn = $data->NISN;
        $nama = $data->Nama_anggota2;
...
?>
 ...
 <div class="container">
                ...
                <div class="widget-tabs-int">
                    ...
                    <div class="widget-tabs-list">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="<?php echo base_url('Home/anggota1CEO') ?>">Anggota 1</a></li>
                            <li class="active"><a href="<?php echo base_url('Home/anggota2CEO') ?>">Anggota 2</a></li>
                        </ul>
                        <div class="tab-content tab-custom-st">

                            <div id="anggota2" class="tab-pane fade in active">
                                <?php echo form_open_multipart('Home/submit_data_anggota2CEO')?>
                                    <div class="tab-ctn">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-example">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder="NISN" name="nisn_anggota2_ceo"
                                                                            id="nisn_anggota2_ceo"
                                                    ...
                                                    <div class="form-example-int form-horizental mg-t-15">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                                                    <label class="hrzn-fm">Nama Anggota 2</label>
                                                                </div>
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Nama" name="nama_anggota2_ceo"
                                                                            id="nama_anggota2_ceo"
                                                                    ...
                                                                    <div class="nk-int-st">
                                                                        <div class="bootstrap-select fm-cmp-mg">
                                                                            <select class="selectpicker"
                                                                                name="jk_anggota2_ceo" id="jk_anggota2_ceo">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Kota" name="kota_anggota2_ceo"
                                                                            id="kota_anggota2_ceo" 
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control"
                                                                            name="tgl_anggota2_ceo" id="tgl_anggota2_ceo"
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="number"
                                                                            ...
                                                                            name="kelas_anggota2_ceo" id="kelas_anggota2_ceo"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Alamat" name="alamat_anggota2_ceo"
                                                                            value="<?php if (isset($alamat)) {echo $alamat;}?>"
                                                                            id="alamat_anggota2_ceo" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="text" class="form-control input-sm"
                                                                            placeholder="Kontak" name="kontak_anggota2_ceo"
                                                                            value="<?php if (isset($kontak)) {echo $kontak;}?>"
                                                                            id="kontak_anggota2_ceo" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="file" class="form-control input-sm"
                                                                            ...
                                                                            name="foto_anggota2_ceo" id="foto_anggota2_ceo"
                                                                            accept="image/*"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                                    <div class="nk-int-st">
                                                                        <input type="file" class="form-control input-sm"
                                                                            placeholder="Scan" name="scan_anggota2_ceo"
                                                                            id="scan_anggota2_ceo" accept="image/*"
    ...
    <script>
        var uploadField1 = document.getElementById("foto_anggota2_ceo");
        ...
        var uploadField2 = document.getElementById("scan_anggota2_ceo");
